...
namespace ZEngine {
	...
	class VulkanAPI {
    public:
		VulkanAPI() : window(static_cast<GLFWwindow*>(Application::Get().GetWindow().GetNativeWindow()))
		{
		};
   ...
   //     }
		...
		void createGraphicsPipeline() {
			//PROJECT_DIR"/Sandbox/assets/shaders/slang.spv"
			vk::raii::ShaderModule shaderModule = createShaderModule(readFile(PROJECT_DIR"/Sandbox/assets/shaders/slang.spv"));
